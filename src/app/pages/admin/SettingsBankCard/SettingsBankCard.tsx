  ...
  return (
    <div>
      ...
      <button
        ...
        type="button"
        className="text-white mb-5 bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
      >
        Thêm thẻ mới
      </button>
      <table className="relative w-full text-left text-sm text-gray-500 shadow-md dark:text-gray-400 rtl:text-right">
        ...
        {!cards.length && (
          <div className="flex p-20 justify-center items-center">Trống</div>
        )}
