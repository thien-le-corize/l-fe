...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
    ref={sidebar}
      className={`z-102 bg-neutral-100 absolute left-0 top-0 flex h-screen w-72.5 flex-col overflow-y-hidden duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
            ...
            <ul className='mb-6 flex flex-col gap-1.5'>
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname?.includes('/admin/contracts') &&
                    'bg-slate-400'
                  }`}
                >
                  <svg
              ...
              <li>
                <Link
                  href='/admin/users'
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname?.includes('/admin/users') && 'bg-slate-400'
                  }`}
                >
                  <svg
                    className='fill-current'
