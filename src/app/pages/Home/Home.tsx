    ...
    <div id="main__content">
      ...
      <section className="partner">
        <div className="container">
          <div className="swiper-container swiperPartner">
            <div className="swiper-wrapper">
              ...
              <div className="swiper-slide">
                <Image
                  layout="fill"
                  src="https://demo1.web678.com/wp-content/uploads/2021/11/logo_partner_7.png"
                  alt="partner"
                />
              </div>
              {/* Slides */}
              <div className="swiper-slide">
                <Image
                  layout="fill"
                  src="https://demo1.web678.com/wp-content/uploads/2021/11/logo_partner_6.png"
                  alt="partner"
                />
              </div>
              {/* Slides */}
              <div className="swiper-slide">
                <Image
                  layout="fill"
                  src="https://demo1.web678.com/wp-content/uploads/2021/11/logo_partner_5.png"
                  alt="partner"
                />
              </div>
              {/* Slides */}
              <div className="swiper-slide">
                <Image
                  layout="fill"
                  src="https://demo1.web678.com/wp-content/uploads/2021/11/logo_partner_4.png"
                  alt="partner"
                />
              </div>
              {/* Slides */}
              <div className="swiper-slide">
                <Image
                  layout="fill"
                  src="https://demo1.web678.com/wp-content/uploads/2021/11/logo_partner_3.png"
                  alt="partner"
                />
              </div>
              {/* Slides */}
              <div className="swiper-slide">
                <Image
                  layout="fill"
                  src="https://demo1.web678.com/wp-content/uploads/2021/11/logo_partner_2.png"
                  alt="partner"
                />
              </div>
            </div>
